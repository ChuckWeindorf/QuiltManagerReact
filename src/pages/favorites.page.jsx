    ...
    return (
      <>
        {arrFavs.map((image, index) => {
          return (
            <div className="favOne" key={`d${index}`}>
              ...
              <img
                src={`${import.meta.env.VITE_ARTIFACTPATH}/${
                  image.CatFileName
                }`}
              ...
              <button
                key={"f" + index}
                id={"f" + image.FavoriteID}
                className="favDelete"
                onClick={DeleteFave}
              >
                delete
              </button>
              <div className="favFile">
                <p className="favHigh">{image.CatFileName}</p>
              </div>
            </div>
          );
        })}
