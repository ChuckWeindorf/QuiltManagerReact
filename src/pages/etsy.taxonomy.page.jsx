...
function EtsyPage(){
    ...
    useEffect( () => {
        ...
        function buildTRfromObject(tmpArr,vintLevel)
       {
        return tmpArr.map((element,index )=> { 
            return( <tr key={index}>
                        <td key={index} id={index}><button id={`L${vintLevel}${index}`} type="button" 
                                 onClick={buildArray}>{element.id}</button></td> 
    ...
    return (
       <>
        <h1>etsy Taxonomy</h1>
        <div><button type="button" onClick={resetAll}>Start Over</button></div>
        <table>
        <tbody>
        {buildTRfromObject(arrTax1,1)}
        <tr><td>====</td><td>======================</td></tr>
        {arrTax2[0] && buildTRfromObject(arrTax2,2)}
        {arrTax2[0] && <tr><td>====</td><td>======================</td></tr>}
        {arrTax3[0] && buildTRfromObject(arrTax3,3)}
        {arrTax3[0] && <tr><td>====</td><td>======================</td></tr>}
        {arrTax4[0] && buildTRfromObject(arrTax4,4)}
        {arrTax4[0] && <tr><td>====</td><td>======================</td></tr>}
        {arrTax5[0] && buildTRfromObject(arrTax5,5)}
        {arrTax5[0] && <tr><td>====</td><td>======================</td></tr>}
        {arrTax6[0] && buildTRfromObject(arrTax6,6)}
        {arrTax6[0] && <tr><td>====</td><td>======================</td></tr>}
        {arrTax7[0] && buildTRfromObject(arrTax7,7)}
        </tbody>
